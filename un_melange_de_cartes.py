...
while len(treize_cartes) != 1:
    nouvelle_ordre=[treize_cartes[0]]+ nouvelle_ordre
    treize_cartes.pop(0)
    nouvelle_ordre=[nouvelle_ordre[len(nouvelle_ordre)-1]]+ nouvelle_ordre[0:len(nouvelle_ordre)-1]
nouvelle_ordre=[treize_cartes[0]]+nouvelle_ordre
print(nouvelle_ordre)
